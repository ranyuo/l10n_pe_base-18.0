...
class TestValidationInvoiceBase(TransactionCase):
    ...
    def test_validation_invoice(self):
        with open(file_path('l10n_pe_edi_doc/tests/data/20608902211-01-FA11-00000249.xml'),'r',encoding='ISO-8859-1') as f_xml:
            xml_file = ET.parse(f_xml)

        with open(file_path('l10n_pe_edi_doc/tests/sunat_archivos/sfs/VALI/commons/xsl/validation/2.X/ValidaExprRegFactura-2.0.1.xsl'),'r',encoding='ISO-8859-1') as f_xsl:
